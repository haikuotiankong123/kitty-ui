    ...
    <div class="table-container">
        ...
        <om-table :data="dataResp"
            ...
            <template v-slot:status="{row}">
                ...
                <span v-else>
                    <el-tag type="warning" size="mini">禁用</el-tag>
                </span>
            </template>
...
<script>
import {listConfigWorkGroup} from '@/mock/modules/listConfigWorkGroup'
...
      	initColumns() {
			this.columns = [
                ...
                {prop:"createTime", label:"添加时间", minWidth:100},
                {prop:"isDefault", label:"是否默认",isSlot: true, minWidth:100},
...
      	},
		...
		findPageFunc(data) {
            ...
            this.dataResp = {content: listConfigWorkGroup()}
            data.callback()
            return;
