    ...
    <div class="table-container">
        ...
        <el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
			...
			<el-form-item label="" prop="customerId" >
				<el-input v-model="editDataForm.customerId" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="" prop="configId" >
				<el-input v-model="editDataForm.configId" auto-complete="off"></el-input>
			</el-form-item>
...
export default {
    ...
    computed:{
        ...mapState('usrCustomerValue', {
            dataResp: state => state.dataResp,
            dataForm: state => state.dataForm
        })
    },
    methods:{
        ...mapActions('usrCustomerValue', ['findPage', 'findAll', 'save', 'delete']),
...
      	initColumns() {
			this.columns = [
                ...
                {prop:"customerId", label:"", minWidth:100},
                {prop:"configId", label:"", minWidth:100},
                {prop:"jsonValue", label:"", minWidth:100},
